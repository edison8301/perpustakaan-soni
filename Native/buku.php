...
<body class="is-preload">
    ...
    <center><h2><b>Data Buku</b></h2><br/></center>
        <div class="page-heading">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-12">
        <button onclick="window.location.href='add.php'" class="btn btn-primary" type="submit">Tambah Buku</button>
        ...
        <br/><br/>
            ...
            <tr>
                <th>ID Buku</th> <th>Judul</th> <th>Kategori</th> <th>Penulis</th> <th>Action</th>
            </tr>
            <?php  
            ...
            <form action="buku.php" method="post" name="form1"></center>
              </div>
                </div>
              </div>
            </div>
